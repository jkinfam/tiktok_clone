...
class VideoPostState extends ConsumerState<VideoPost>
  ...
  final VideoPlayerController _videoPlayerController =
      VideoPlayerController.asset("assets/videos/KakaoTalk_Video.mp4");
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            top: 40,
            child: IconButton(
              onPressed: _onPlaybackConfigChaged,
              icon: FaIcon(
              ...
              child: Column(
                children: [
                  ...
                  VideoButton(
                    ...
                    text: S.of(context).likeCount(67896789),
                  ),
                  Gaps.v24,
                  GestureDetector(
                    ...
                    child: VideoButton(
                      ...
                      text: S.of(context).commentCount(12341243),
                    ),
                  ),
                  Gaps.v24,
                  const VideoButton(
